...
// 8. Learn about Linq, collections and interfaces. IEnumerable<T> .Any() .Sum() .Where() .Select() .ToList() etc. https://app.pluralsight.com/ilx/video-courses/c-sharp-10-linq-fundamentals/course-overview mod 1 - 8.
